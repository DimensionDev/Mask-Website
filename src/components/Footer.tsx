      ...
      <footer className="bg-blue-1000 flex justify-center flex-grow-0">
        <div className="container px-10 md:px-8 sm:px-6">
          ...
          >
            ...
            <div className="flex pl-4 sm:pl-0 md:pl-0 md:mt-0 max-md:mt-4 col-span-2">
              ...
              <div className="flex flex-col justify-start max-w-lg whitespace-nowrap md:ml-12 ml-16 sm:ml-0 md:ml-0 sm:mt-8 md:mt-8">
                <div className="py-1 flex flex-col">
            ...
            <div className="flex flex-col mt-8 justify-start w-full pb-12 min-lg:mt-0 min-lg:ml-20">
              <div className="py-1 flex flex-col">
                <p className="text-2xl text-white min-lg:mb-6">Community</p>
                <div className="grid min-lg:grid-cols-3 grid-cols-7 gap-x-4 max-md:gap-x-2 w-72 mt-6 min-lg:w-36 gap-y-4 min-lg:mt-0">
                  <a
                  ...
                  <a
                    href="https://www.youtube.com/c/MaskNetwork"
                    target="_blank"
                    rel="noreferrer"
                    aria-label="Goto reddit"
                  >
